...
<form action="@if(isset($user)) {{route('admin.profile.update', $user)}} @else {{route('admin.profile.store')}} @endif"
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="form-group row">
                ...
                @php
                $ids = (isset($user->role) && $user->role->count() > 0 ) ? array_pluck($user->role->toArray(), 'id') :
                null;
                @endphp
                ...
                <div class="col-sm-6">
                    ...
                    <select name="role_id" id="role" class="form-control">
                        ...
                        <option value="{{$role->id}}" @if(!is_null($ids) && in_array($role->id, $ids))
                            {{'selected'}}
            ...
            <ul class="list-group row">
                ...
                <li class="list-group-item">
                    ...
                    <div class="img-thumbnail  text-center">
                        <img src="@if(isset($user)) {{asset('storage/'.$user->thumbnail)}} @else {{asset('images/no-thumbnail.jpeg')}} @endif"
